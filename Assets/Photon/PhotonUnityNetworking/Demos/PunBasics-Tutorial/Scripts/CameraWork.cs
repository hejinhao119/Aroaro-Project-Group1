...
namespace Photon.Pun.Demo.PunBasics
{
    ...
    public class CameraWork : MonoBehaviour
    {
        ...
        // Represents the current velocity, this value is modified by SmoothDamp() every time you
        // call it.
        ...
        /// <summary>
        /// MonoBehaviour method called after all Update functions have been called. This is useful
        /// to order script execution. For example a follow camera should always be implemented in
        ...
        private void LateUpdate()
        {
            ...
            // where the Main Camera is different everytime we load a new scene, and reconnect when
            // that happens
        ...
        /// <summary>
        /// Raises the start following event. Use this when you don't know at the time of editing
        /// what to follow, typically instances managed by the photon network.
        /// </summary>
        ...
        private void Apply()
        {
            ...
            cameraTransform.position += currentRotation * Vector3.forward * 1.0f;
